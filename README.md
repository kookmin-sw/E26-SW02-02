...
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **공민경** | 소프트웨어학부 | 리눅스, 네트워크, 보안 |
| **이수연** | 소프트웨어학부 | 게임, 보안, 인공지능 |
| **조인준** | 소프트웨어학부 | 게임, 인공지능, 소프트웨어 |
...
저희 팀은 소프트웨어에 관심을 가지고 다양한 아이디엉를 함께 탐구하는 팀입니다.
서로의 지식과 경험을 공유하면서 함께 성장하는 것을 목표로 하고 있습니다. 
